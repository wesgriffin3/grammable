...
RSpec.describe CommentsController, type: :controller do
  describe "comments#create action" do
    it "should allow users to comment on a gram" do
    ...
    it "should require someone be logged in to comment" do
      gram = FactoryBot.create(:gram)
      post :create, params: { gram_id: gram.id, comment: { message: 'awesome gram!' } }
    ...
    it "should return http status code of not found if the gram isnt found" do
      user = FactoryBot.create(:user)
      sign_in user
      post :create, params: { gram_id: 'SPACECAT', comment: { message: 'awesome gram!' } }
