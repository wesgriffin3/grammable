...
RSpec.describe GramsController, type: :controller do
  ...
  describe"gram#destroy action" do
    ...
    it "should allow users to delete a gram" do
      gram = FactoryBot.create(:gram)
      sign_in gram.user
      delete :destroy, params: { id: gram.id } 
    ...
    it "should return a 404 error if we cannot find a gram with specified id" do
      user = FactoryBot.create(:user)
      sign_in user
  ...
  describe "grams#edit action " do
    it "shouldn't let a user who didn't make the gram edit the gram" do
      gram = FactoryBot.create(:gram)
      user = FactoryBot.create(:user)
      sign_in user
    ...
    it "shouldn't allow unauthorized users to edit grams" do
      gram = FactoryBot.create(:gram)
      get :edit, params: { id: gram.id }
      expect(response).to redirect_to new_user_session_path
    end
